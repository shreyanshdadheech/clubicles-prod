            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
              ...
              <div className="lg:col-span-1 flex items-end">
                <Button 
                  ...
                  className="w-full !bg-white !text-black hero-glass-backplate font-doto rounded-2xl font-bold text-4xl md:text-2xl  inline-block text-white tracking-wider shadow-2xl font-semibold hover:bg-gray-100 hover:!text-white  hover:scale-105 h-14 rounded-xl transition-all duration-200 shadow-lg"
                >
